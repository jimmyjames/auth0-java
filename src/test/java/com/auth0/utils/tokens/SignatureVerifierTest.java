...
public class SignatureVerifierTest {
    ...
    public void noneAlgorithm() {
        ...
        SignatureVerifier signatureVerifier = new NoneVerifier();
        signatureVerifier.verifySignature(token);
    ...
    private static class NoneVerifier extends SignatureVerifier {
        NoneVerifier() {
            super(null, "none");
        }
    }
